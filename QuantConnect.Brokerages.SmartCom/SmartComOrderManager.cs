...
namespace QuantConnect.Brokerages.SmartCom
{
    public class SmartComOrderManager//:IOrderManager
    {
        ...
        public void PlaceOrder(Order order)
        {
            ...
            RawOrderFactory factory = new RawOrderFactory();
        ...
        public void CancelOrder(Order order)
        {
            ...
            this.singleton.Instance.CancelOrder(order.Tag, order.Symbol.ID.Symbol, order.Id.ToString());
